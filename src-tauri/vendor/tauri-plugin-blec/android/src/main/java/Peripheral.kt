...
class Peripheral(
    ...
    private val notifyChannelLock = Any()
    ...
    private val callback = object : BluetoothGattCallback() {
        ...
        override fun onConnectionStateChange(gatt: BluetoothGatt?, status: Int, newState: Int) {
            if (status == BluetoothGatt.GATT_SUCCESS && newState == BluetoothGatt.STATE_CONNECTED && gatt != null) {
                ...
                this@Peripheral.clearNotifyChannel()
        ...
        private fun handleCharacteristicChanged(
            ...
            val channel = synchronized(this@Peripheral.notifyChannelLock) {
                this@Peripheral.notifyChannel
            }
            channel?.let {
    ...
    fun setNotifyChannel(channel: Channel) {
        synchronized(this.notifyChannelLock) {
            this.notifyChannel = channel
        }
    }

    private fun clearNotifyChannel() {
        synchronized(this.notifyChannelLock) {
